...
PpgAnimation* ppg_widget_animate         (GtkWidget        *widget,
                                          guint             duration_msec,
                                          PpgAnimationMode  mode,
                                          const gchar      *first_property,
                                          ...) G_GNUC_NULL_TERMINATED;
PpgAnimation* ppg_widget_animate_full    (GtkWidget        *widget,
                                          guint             duration_msec,
                                          PpgAnimationMode  mode,
                                          ...
                                          const gchar      *first_property,
                                          ...) G_GNUC_NULL_TERMINATED;
PpgAnimation* ppg_widget_animatev        (GtkWidget        *widget,
                                          guint             duration_msec,
                                          PpgAnimationMode  mode,
                                          const gchar      *first_property,
                                          va_list           args);
